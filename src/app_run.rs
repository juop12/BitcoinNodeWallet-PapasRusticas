...
fn ui_response_to_message(
    ...
    match action {
        ...
        UIResponse::LoadingScreenUpdate(progress) => {
            handle_loading_screen_update(&builder, progress)
        }
    }
}
...
pub fn start_app(args: Vec<String>) {
    ...
    let update_wallet_join_handle =
        send_ui_update_request(&sender_for_update_wallet, node_status_for_update_wallet);
